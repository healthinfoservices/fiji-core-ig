# Home - Fiji Core FHIR Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://healthinfoservices.net/fiji-core-ig/ImplementationGuide/fiji.core.ig | *Version*:1.0.0 |
| Draft as of 2026-03-05 | *Computable Name*:FijiCoreIG |

## Fiji Core FHIR IG

#### FSH Code Package for Fiji Core FHIR Implementation Guide - Initial State
...
```json
{
  ...
  "id" : "fiji.core.ig",
  "url" : "https://healthinfoservices.net/fiji-core-ig/ImplementationGuide/fiji.core.ig",
  "version" : "1.0.0",
  "name" : "FijiCoreIG",
  "title" : "Fiji Core FHIR Implementation Guide",
  "status" : "draft",
  "date" : "2026-03-05T23:02:15+00:00",
  "description" : "FHIR Implementation Guide with Profiles for healthcare interoperability in Fiji",
  "packageId" : "fiji.core.ig",
  "license" : "MIT",
  "fhirVersion" : ["4.3.0"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  {
    "id" : "pacific_base_ig",
    "uri" : "https://healthinfoservices.net/pacific-base-ig/ImplementationGuide/pacific.base.ig",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://healthinfoservices.net/fiji-core-ig/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/FijiAllergyIntolerance"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/FijiCondition"
      },
      "name" : "FijiCondition",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/FijiOrganization"
      },
