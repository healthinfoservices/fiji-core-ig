# Pacific Clan Affiliation - Fiji Core FHIR Implementation Guide v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://healthinfoservices.net/fiji-core-ig/StructureDefinition/pacific-clan-affiliation | *Version*:1.0.0 |
| Active as of 2026-03-05 | *Computable Name*:PacificClanAffiliation |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fiji.core.ig|current/StructureDefinition/pacific-clan-affiliation)
...
```json
{
  ...
  "url" : "https://healthinfoservices.net/fiji-core-ig/StructureDefinition/pacific-clan-affiliation",
  "version" : "1.0.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://healthinfoservices.net/fiji-core-ig/StructureDefinition/pacific-clan-affiliation"
    },
    {
